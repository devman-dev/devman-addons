...
class PfGatewayCommissionPayableReport(models.Model):
    ...
    percentage = fields.Float(string="Porcentaje", digits=(16, 4), readonly=True, aggregator=False)
    transaction_count = fields.Integer(string="Total transacciones", readonly=True, aggregator=False)
    total_amount = fields.Float(string="Total importe", digits=(16, 2), readonly=True, aggregator=False)
    retained_commission = fields.Float(string="Comision retenida", digits=(16, 2), readonly=True, aggregator=False)
